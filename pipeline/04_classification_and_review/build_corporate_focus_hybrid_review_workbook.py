...
def build_readme_sheet() -> pd.DataFrame:
    return pd.DataFrame(
        [
            {
                "section": "Purpose",
                "detail": "Hybrid workbook for human review of corporate-academic/media relations and later included groups.",
            },
            {
                "section": "master_review",
                "detail": "Main sheet: one row per included non-corporate group, compared with its best corporate match.",
            },
            {
                "section": "included_linked",
                "detail": "Subset with an explicit direct link to corporate (best_dyad present / direct pair).",
            },
            {
